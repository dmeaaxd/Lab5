...
public class Help implements Command {
    ...
    public Help(CommandHolder commandHolder){
    ...
    public String execute(CommandInvoker commandInvoker, ArrayList<HumanBeing> collection, String arg){
        if (arg.isEmpty()){
            return commandHolder.help(commandInvoker);
        } else {
    ...
    public String getHelp() {
        ...
        final String ANSI_RESET = "\u001B[0m";
        return ANSI_GREEN+"help"+ANSI_GREEN + ANSI_RESET+" - вывести справку по доступным командам"+ANSI_RESET;
    }
}
