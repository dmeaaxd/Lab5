...
public class Clear implements Command {
    ...
    public Clear(CommandHolder commandHolder){
    ...
    public String execute(CommandInvoker commandInvoker, ArrayList<HumanBeing> collection, String arg){
        if (arg.isEmpty()) {
            return commandHolder.clear(collection);
        } else {
    ...
    public String getHelp() {
        ...
        final String ANSI_RESET = "\u001B[0m";
        return ANSI_GREEN+"clear"+ANSI_GREEN + ANSI_RESET+" - очистить коллекцию"+ANSI_RESET;
    }
}
