...
public class UpdateId implements Command {
    ...
    public UpdateId(CommandHolder commandHolder) {
    ...
    public String execute(CommandInvoker commandInvoker, ArrayList<HumanBeing> collection, String arg) {
        if (!arg.isEmpty()) {
            return commandHolder.updateId(collection, arg);
        } else {
    ...
    public String getHelp() {
        ...
        final String ANSI_RESET = "\u001B[0m";
        return ANSI_GREEN+"update id"+ANSI_GREEN + ANSI_RESET +" - обновить значение элемента коллекции, id которого равен заданному"+ANSI_RESET;
    }
}
