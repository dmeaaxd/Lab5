...
public class Save implements Command {
    ...
    public Save(CommandHolder commandHolder) {
    ...
    public String execute(CommandInvoker commandInvoker, ArrayList<HumanBeing> collection, String arg) {
        if (arg.isEmpty()) {
            return commandHolder.save(collection);
        } else {
    ...
    public String getHelp() {
        ...
        final String ANSI_RESET = "\u001B[0m";
        return ANSI_GREEN+"save"+ANSI_GREEN + ANSI_RESET +" - сохранить коллекцию в файл"+ANSI_RESET;
    }
}
